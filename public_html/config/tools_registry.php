...
return [
    ...
    'reduce-pdf-quality' => [
        'name' => 'Reduce PDF Quality',
        'category' => 'compress',
        'icon' => '📉',
        'color' => '#FF5722',
        'short_description' => 'Reduce PDF quality for smaller file size.',
        'long_description' => 'Reduce your PDF quality to achieve smaller file sizes. Choose from low, medium, or high quality settings based on your needs.',
        'is_active' => true,
        'is_premium' => false,
        'is_featured' => false,
        'sort_order' => 4,
    ...
    'remove-metadata' => [
        ...
        'icon' => '🏷️',
        'color' => '#795548',
        'short_description' => 'Strip metadata from PDF files.',
        'long_description' => 'Remove all metadata from your PDF including author, title, creation date, and other hidden information for privacy.',
        'is_active' => true,
        'is_premium' => false,
        'is_featured' => false,
        'sort_order' => 12,
    ...
    'remove-blank-pages' => [
        ...
        'icon' => '📃',
        'color' => '#9E9E9E',
        'short_description' => 'Automatically remove blank pages from PDF.',
        'long_description' => 'Detect and remove blank or nearly blank pages from your PDF automatically. Customize sensitivity for detection.',
        'is_active' => true,
        'is_premium' => false,
        'is_featured' => false,
        'sort_order' => 10,
